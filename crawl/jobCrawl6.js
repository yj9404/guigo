...
var jobCrawl1 = () =>{
    return new Promise ((resolve, reject)=>{
        ...
        , devtools : true  
            ...
            var beginquery = "select * from Post where FK_BoardID = 6 order by PostID desc limit 26;";
            ...
            await page.goto("http://www.sogang.ac.kr/front/boardlist.do?bbsConfigFK=2", { waitUntil: "networkidle0" });
            ...
            for (var i = 1; i < board.length; ++i) {
                ...
                if(posturl.length==0) posturl="http://www.sogang.ac.kr/front/boardlist.do?bbsConfigFK=2";
                date=date.trim();
                text=text.trim();
                ...
                if(postSet.has(text) == false){
                    flag = 1;
                    insertQuery += `(null, '${text}',  '${posturl}', '${date}', ${boardID}, 6) ,`;
                }        
            }
