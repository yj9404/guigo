...
var jobCrawl4 = () =>{
    return new Promise((resolve, reject)=>{
        ...
        , devtools : true  
            ...
            var beginquery = "select * from Post where FK_BoardID = 4 order by PostID desc limit 20;";
            ...
            for (var i = 1; i <= board.length; ++i) {
                ...
                var predate = await page.waitFor(`div#wrap > div#contentsWrap > div#contents > table.listTable.tdCenter.spaceB20 > tbody > tr:nth-child(${i}) > td:nth-child(1) `)
                var date = await page.evaluate(predate => predate.textContent, predate);
                if(date.length == 0) date = getday();
                
                var body = await page.waitFor(`div#wrap > div#contentsWrap > div#contents > table.listTable.tdCenter.spaceB20 > tbody > tr:nth-child(${i}) > td:nth-child(3) > a`)
