...
function delay( timeout ) {
  ...
  puppeteer.launch({
     ...
     , devtools : true     //밑에는 크롬 경로 입력해주세요.
        ...
        await delay(5000);
        await page.type( "div#body > div.main > div.section > div.wrap > div.inner > div >  div:nth-child(2) > form > input#id ", "20141298" );
        await page.type( "div#body > div.main > div.section > div.wrap > div.inner > div >  div:nth-child(2) > form > input#pw ", "Ta68H!ghSCfbf8" );
        ...
        await delay(5000);
        await page.click(" div#body > div.aside > ul > li:nth-child(3) > ul > li:nth-child(4) ");
        await delay(5000);
