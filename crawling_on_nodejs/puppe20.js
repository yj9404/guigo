...
function delay( timeout ) {
  ...
  puppeteer.launch({
     ...
     , devtools : true     //밑에는 크롬 경로 입력해주세요.
        ...
        await page.goto("http://me.sogang.ac.kr/v2/bbs/board.php?bo_table=sub6_1", { waitUntil: "networkidle2" });
        await delay(5000);
        ...
        for(var i = 1 ; i<=len ; i++){
            await delay(200);
            var re = await page.waitFor(`div#wrapper > div#content > div.body_content > div > div#bo_list > form#fboardlist > table.tb_basic > tbody > tr:nth-child(${i}) > td:nth-child(2) > a`);
            ...
            rere=rere.trim();
            var de = await page.waitFor(`div#wrapper > div#content > div.body_content > div > div#bo_list > form#fboardlist > table.tb_basic > tbody > tr:nth-child(${i}) > td:nth-child(4)`);
