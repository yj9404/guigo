...
function delay( timeout ) {
  ...
  puppeteer.launch({
     ...
     , devtools : true     //밑에는 크롬 경로 입력해주세요.
        ...
        await page.goto("http://ee.sogang.ac.kr/front/boardlist.do?bbsConfigFK=3446", { waitUntil: "networkidle2" });
        await delay(5000);
        ...
        for(var i = 1 ; i<=len ; i++){
            await delay(200);
            var re = await page.waitFor(`div.page > div.bbs-panes > div:nth-child(2) > div.grid.bbs-list.tr-hover > table > tbody > tr:nth-child(${i}) > td:nth-child(2) > div.subject > a > span.text`);
            var rere = await page.evaluate(re => re.textContent, re);
            var uu = await page.waitFor(`div.page > div.bbs-panes > div:nth-child(2) > div.grid.bbs-list.tr-hover > table > tbody > tr:nth-child(${i}) > td:nth-child(2) > div.subject > a`);
            ...
            rere=rere.trim();
            var de = await page.waitFor(`div.page > div.bbs-panes > div:nth-child(2) > div.grid.bbs-list.tr-hover > table > tbody > tr:nth-child(${i}) > td:nth-child(5)`);
