...
function delay( timeout ) {
  ...
  puppeteer.launch({
     ...
     , devtools : true     //밑에는 크롬 경로 입력해주세요.
        ...
        await page.goto( "http://dblab.sogang.ac.kr/fs2019", { waitUntil : "networkidle2" } );
        await delay(5000);
        // await page.click( " div.container.fixed_header > div.header_wrap.xe-clearfix > header.header.main > nav#gnb.gnb.pc-gnb > ul > li:nth-child(7) > a" )
        // await delay(9000);
        ...
        for(var i = 1 ; i<=len ; i++){
            await delay(200);
            var re = await page.waitFor(`div.container.fixed_header > div.body.fixed-width.sub.right > div#content.content > div.board > div#board_list.board_list > table > tbody > tr:nth-child(${i}) > td:nth-child(2) > a`)
            ...
            var de = await page.waitFor(`div.container.fixed_header > div.body.fixed-width.sub.right > div#content.content > div.board > div#board_list.board_list > table > tbody > tr:nth-child(${i}) > td:nth-child(4)`)
