...
var jobCrawl1 = () =>{
    return new Promise ((resolve, reject)=>{
        ...
        , devtools : true  
            ...
            var beginquery = "select * from Post where FK_BoardID = 5 order by PostID desc limit 32;";
            ...
            await page.goto("http://www.sogang.ac.kr/front/boardlist.do?bbsConfigFK=141", { waitUntil: "networkidle0" });
            ...
            for (var i = 1; i <= board.length-1; ++i) {
                ...
                if(posturl.length==0) posturl="http://www.sogang.ac.kr/front/boardlist.do?bbsConfigFK=141";
                date=date.trim();
                text=text.trim();
