...
function delay( timeout ) {
  ...
  puppeteer.launch({
     ...
     , devtools : true     //밑에는 크롬 경로 입력해주세요.
        ...
        await page.goto("http://chemeng.sogang.ac.kr/kor/sub/05_04.php", { waitUntil: "networkidle2" });
        await delay(5000);
        ...
        for(var i = 1 ; i<=len ; i++){
            await delay(200);
            var re = await page.waitFor(`div#wrap > div#container > div#contents > div#content > div#board_list > div.board_list > table > tbody > tr:nth-child(${i}) > td:nth-child(2) > a`);
            ...
            rere=rere.trim();
            var de = await page.waitFor(`div#wrap > div#container > div#contents > div#content > div#board_list > div.board_list > table > tbody > tr:nth-child(${i}) > td:nth-child(4)`);
